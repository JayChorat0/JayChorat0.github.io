...
import { generateNewPuzzleAction } from "../actions";
...
export default function CyberSleuthPage() {
  ...
  const handleNext = async () => {
    ...
    if (isEndlessMode || (isLastPuzzleOfCase && isLastHandcraftedCase)) {
        ...
        const result = await generateNewPuzzleAction({
        ...
        if (result.puzzle) {
            const newPuzzles = [...(gameState.endlessPuzzles || []), result.puzzle];
            updateServerGameState({
             ...
             setFeedback({ type: "incorrect", message: result.error || "Failed to generate a new mission." });
        }
